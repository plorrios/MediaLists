...
public class MusicListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public MusicListAdapter(ArrayList<Song> myMusicList, MusicListSearchAdapter.IClickListener monClk, Context mcontext) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == CONTENT) {
            ...
            return new MusicListSearchAdapter.AdViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_ad, parent, false));
        }
    }
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder mholder, int position) {
        ...
        if (getItemViewType(position) == CONTENT) {
            ...
            final MusicListSearchAdapter.MusicListViewHolder holder = (MusicListSearchAdapter.MusicListViewHolder) mholder;
            ...
            MusicListSearchAdapter.AdViewHolder holder = (MusicListSearchAdapter.AdViewHolder) mholder;
